...
export function AboutMe() {
    ...
    return (
        <section ref={sectionRef} className="py-24 bg-[#f5f5f5] relative overflow-hidden">
            ...
            {/* Decorative orange scribble below-right */}
            ...
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="about-images relative">
                        {/* Outer board - design moodboard with swatches */}
                        <div className="relative w-full max-w-[500px]">
                            ...
                            {/* Portrait photo overlaid at bottom-right, notched */}
                            <div
                    ...
                    <div className="about-content">
                        ...
                        <p className="text-gray-500 text-base leading-relaxed mb-3">
                            ...
                            designer on a mission to redefine digital experiences. With a keen eye
                            for detail and an insatiable curiosity for innovative design.
                        </p>
